...
const AllTables = React.lazy(() => import('./views/tables/AllTables'))
const AddNewTables = React.lazy(() => import('./views/tables/AddNewTables'))
...
const routes = [
  ...
  { path: '/tables', name: 'Tables', component: AllTables, exact: true },
  { path: '/tables/all-tables', name: 'All Tables', component: AllTables },
  { path: '/tables/add-new-tables', name: 'Add New Tables', component: AddNewTables },
]
